import { AnimationWithMetadata, stopAnimation } from "./animate";
...
export type AnimationControls = {
  ...
  play: AnimationWithMetadata["play"];
  pause: AnimationWithMetadata["pause"];
  finish: AnimationWithMetadata["finish"];
  cancel: AnimationWithMetadata["cancel"];
  reverse: AnimationWithMetadata["reverse"];
  stop: () => void;
...
export const createAnimationControls = (
  animations: AnimationWithMetadata[]
): AnimationControls => {
  ...
  const stop = () => {
    animations.forEach(animation => stopAnimation(animation));
  };
